...
function Register() {
    ...
    return (
        <div className="bg-sky-900 h-screen flex items-center justify-center">
            <div className="registrationBox flex gap-10 justify-center items-center flex-col border-2 border-white  rounded-lg p-6">
                <div className="font-bold text-blue-50 text-2xl">
                    Leaderboard Registration
                </div>
                <div className="registrationName flex items-center">
                    <p className="text-white font-semibold bg-gray-800 rounded-md p-1 m-2 w-fit">
                        Name
                    </p>
                    <input
                ...
                <button
                    onClick={add}
                    className="w-fit px-6 py-2 bg-slate-500 rounded-xl active:bg-slate-400  hover:bg-sky-100"
                >
                    Register
                </button>
            </div>
