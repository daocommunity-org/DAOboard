...
function SetCoordinator() {
    return (
        ...
        <div className='flex flex-col gap-6 justify-center items-center'>
            ...
            <button className="w-fit h-fit p-2 bg-slate-500 rounded-xl  border-2 border-blue-200 active:bg-slate-400 transition-all ease-in-out hover:scale-105 hover:bg-red-300">Set Coordinator</button>
        </div>
    )
}
