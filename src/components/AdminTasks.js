...
function AdminTasks() {
    ...
    return (
        <div className='bg-sky-900 min-h-screen flex justify-start gap-10'>
            <AdminNav />
            <div className='border-2 border-blue-200 rounded-xl m-auto p-10 flex flex-col gap-8 w-[75%]'>
                ...
                <div className='renderfunctions w-full flex flex-col justify-center items-center'>
